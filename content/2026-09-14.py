...
TLDR = [
    "Purchase-tagged TikTok posts grew 55 percent in count last quarter while response to them fell 41 percent, and the typical tagged post earns a 1.4 percent engagement rate against 6.4 percent for everything else, across 58,037 posts.  Judge your tagged posts against the 1.4 percent benchmark rather than your overall average, and rewrite one brief so the tag sits on a format people already watch instead of on a post that exists only to carry it.",
    ...
    "Old Navy anchored back-to-school on MrBeast and reports a 22 percent traffic lift to its kids' range in the days after launch, from over 100 million views, in a quarter when comparable sales fell 4 percent and the sales read is a quarter away.  Write down the fast metric and the slow metric with the date you will read each before your next creator campaign goes live, and put the slow one in the budget approval.",
