...
LEAD = {
    "headline": "TWO FORECASTERS RAISED THE US AD MARKET IN TWENTY FOUR HOURS.  THE SAME FIRM PUTS NEXT YEAR AT 4.1 PERCENT",
    "deck": "The IAB raised its 2026 US forecast to 12.3% this morning, up from the 9.5% it published in January.  Madison and Wall raised its US number to 15.6% yesterday.  Both upgrades are real, and almost none of the growth inside them is demand for the kind of work you make.  The number that should be in your 2027 plan is 4.1.",
    "stamps": [
    ...
    "body": [
        ...
        "Yesterday Madison and Wall went further.  It raised its US growth projection by 3.5 points to <mark>15.6%</mark> and its global number by 2.2 points to 11.6%, reported by Joe Mandese at MediaPost.  MediaPost's blended composite of multiple forecasters lands at 9.6% for the US, which tells you Madison and Wall is the outlier on the high side, not the consensus.",
        ...
        "Which brings you to the number nobody is putting in a headline.  <mark>Madison and Wall's own 2027 forecast for the US is 4.1%.</mark>  Global is 5.9%.  MediaPost's composite has US 2027 at 4.4%.  The same people telling you this year grows 15.6% are telling you next year grows a quarter of that, because the Olympics, the World Cup and the midterms do not come back.",
        "David Cohen, chief executive of the IAB, is careful about it in the release: the first half was strong, major live events delivered, and advertisers have increasingly powerful tools in their arsenal to find and engage customers.  At the same time, the economy has real areas of uncertainty.  There is growth to be found, but there are no easy wins.",
        "One more thing buried in the same study, and it matters more to you than the top line.  Asked which ad types they are increasing focus on, buyers put <mark>creator and influencer advertising and partnerships first, at 54%</mark> — ahead of demographic and cohort targeting at 53%, publishers with first-party data at 48% and contextual at 45%.  The market is growing for a reason that will not repeat, and the money inside it is moving toward the thing you make.",
    ],
    "numbers": [
    ...
    "so_what": "Growth like this is a calendar, not a verdict on your work.  Two once-in-four-years sporting events and an American election cycle are carrying it, which is exactly why the firm with the biggest 2026 number has the smallest 2027 one.  If your next budget conversation is anchored on this year's headline, you are arguing for a level of spending that the market itself says drops by three quarters in twelve months.",
...
SECTIONS = [
    {
        ...
        "items": [
            {
                "title": "A data-removal service bought 17.9 million views on a true-crime channel, and the fear in the video is the product demonstration",
                ...
                "body": [
                    ...
                    "The read itself does the rest.  Your data is being sold right now.  My sponsor Aura will find the brokers selling it and remove you automatically.  Think about where the viewer's head is at minute nineteen of a video about a man living in a family's attic.  Every other sponsorship you buy interrupts the mood the content built.  This one finishes it.",
                    "Here is the part that turns an observation into evidence.  A completely unrelated advertiser landed on the same genre from the opposite end of the market.  Morgan and Morgan, the largest personal injury law firm in America, runs <mark>an average of 230 pieces of branded content a month on YouTube alone</mark>, and its regular creator partners are concentrated in true crime and sensational news coverage — Law&Crime Network, Levi Nichs, Jay Reed.  Shaul Wolf, its senior director of social and creators, explains the selection rule in one line: if you're a fashion influencer and you're promoting a fashion brand, it makes sense.  But if you're a random creator promoting a law firm, it's really out of context.",
                    "The firm also puts a number on the economics that almost nobody publishes.  It says <mark>the cost to reach a thousand people on a sponsored video falls between 30% and 50% in the twelve months after it posts</mark>, because you pay the creator a flat fee once and the views keep arriving for a year.  That is the second half of why this genre works: long, heavy, searchable videos keep getting found, and the price you paid stops moving.",
                    "Now the uncomfortable bit.  Most brand-safety exclusion lists delete true crime by default.  That deletion is usually made in a spreadsheet by somebody who has never watched a minute of it, and for at least two categories it is removing the single best-fitting inventory on the platform.",
                ],
                "numbers": [
            ...
            },
            {
                ...
                "body": [
                    ...
                    "Those two findings are doing different jobs and it is worth separating them.  The first set measures recognition — do people think everyone knows about this.  The second measures legitimacy — does this feel real to me.  You can buy recognition in a single weekend with enough money.  Legitimacy is not on sale at any price, and what the 65% describes is where people go to check.",
                ...
                "flagnote": "This is YouTube's own research about YouTube, published by YouTube.  The survey is United States only and runs on two separate samples fielded in April 2026 — the 77, 78, 79 and 83 comparison comes from 496 respondents aged 14 to 29, while the legitimacy and interest figures come from 939 respondents aged 14 to 44.  The exact survey question is not published, only YouTube's paraphrase of it, and the metric is perceived wide recognition rather than preference or importance.",
                "so_what": "Most brand video briefs quietly assume one job — get this in front of more people.  This study is describing a second job that a lot of budget is accidentally being spent on and never measured against.  When somebody hears about your product from an ad and then goes to YouTube before buying, the YouTube video is not the second impression.  It is the verdict, and it is the only one that gets to be checked.",
    ...
    },
    {
        ...
        "items": [
            {
                "title": "Wrong owner: Wimbledon will not create a creator credential, and the numbers everyone quotes at it were earned without one",
                "hook": "The US Open went from 50 creators to 100.  Wimbledon did 144 million engagements with none.",
                "open": True,
                "stamps": [
                ...
                "so_what": "A creator credential is a licence issued by somebody else, and it is usually the only element of a sports plan you cannot replace at short notice.  Everything else — the talent, the crew, the edit, the media behind it — you can rebuild in a fortnight.  Access you cannot.  And the awkward fact underneath the whole episode is that the property everyone held up as the proof this works had never bought the thing at all.",
            ...
            },
            {
                ...
                "body": [
                    "AEO reported this week.  Total net revenue <mark>1.38 billion dollars, up 8%</mark>, plus a 196 million dollar tariff refund including interest.  Underneath that: <mark>Aerie comparable sales up 19%, American Eagle comparable sales down 1%</mark>.",
                    ...
                    "The campaign's actual result sits in the guidance, and the guidance is modest.  For the quarter that does contain it, the company expects <mark>American Eagle relatively flat and Aerie and Offline in the high teens to 20%</mark>.  Jennifer Foyle, president, on the denim work: we are moving in the right direction, yet there remains work to do.",
                ...
                "so_what": "Attention arrives the week you launch and demand arrives a quarter later, which is why almost everybody grades a campaign on the conversation it generated.  The conversation is not in these numbers.  What is in them is that the division nobody wrote about grew nineteen percent on an always-on creator programme with no talent fee attached, while the division everybody wrote about is guided to flat.  That is not proof the celebrity money was wasted.  It is the comparison your finance director is going to make anyway.",
        ...
        "items": [
            {
                ...
                "body": [
                    ...
                    "The competitive detail is the pricing.  Digiday's read is that Amazon already undercuts rivals on fees, with its buying tool often landing near zero on guaranteed deals against <mark>The Trade Desk's historical 15 to 20%</mark> or Google's similar cut.  Note the hedges — often, near zero, and only on guaranteed deals.  That is not a claim about everything Amazon sells.",
                    "OpenAI has already connected Criteo and StackAdapt and cut deals with the major agency holding companies.  It started testing ads in February and is <mark>reportedly aiming at 100 billion dollars of ad revenue by 2030</mark>, a target that needs compound growth above 200% a year.",
                    "Chris Conetta, director of omnichannel supply at Amazon's buying tool, gives the pitch: conversational ads represent the fastest growing engagement opportunity for brands to reach new and existing audiences.  Nate Elliott, principal analyst for AI at eMarketer, gives the counterweight: it'd be overly generous to call Q4 a stress test for OpenAI's ad business.  They're still trying to build out even many of the basics of a functional ad sales operation, including their team, technology, vendor partnerships, ad formats, and pricing.",
                ],
                "so_what": "Every ad market that has mattered in the last twenty years started as a pilot with one named brand and terrible measurement.  What makes this one move faster than usual is that the demand side is already plumbed in — if your agency buys Amazon, it can buy this without a new contract, a new vendor or a new approval.  The friction that normally slows a new channel down for two years is missing.",
                "do_this": "Ask your media agency this week whether your Amazon buying is set up in a way that could extend into ChatGPT, and if it is, agree in advance what you would need to see reported before you would spend a pound there.",
            },
            {
                ...
                "so_what": "This is the third change in a month that makes a creator's reported audience bigger without making your integration reach more people.  None of them is dishonest on YouTube's part and all of them land on the same side of the negotiation.  The reaction attribution is the sharpest of the three, because it is the first one where the extra viewers demonstrably watched something other than your ad.",
                "do_this": "Add one line to every live sponsorship brief: the creator turns the React live setting to No one before going live, and reports engaged views rather than public views.  Send it to any partner streaming for you in the next fortnight, because the setting has to be changed before the stream starts.",
            },
            {
                "title": "TikTok put creator videos on 4,500 screens in British gyms, taxis and supermarkets",
            ...
            },
            {
                ...
                "so_what": "Discovery for creators currently happens on platform dashboards, in agency decks and in a group chat.  None of those is searchable by someone outside the industry, and all of them index on follower count because that is the field the tools expose.  A profile built for casting workflows indexes on what somebody has actually made, which is a different and better question, and it sits outside any one platform's numbers.",
    ...
    },
    {
        ...
        "items": [
            {
                "title": "Valorant's season got 3% more watch time and nearly a fifth fewer viewers, and Twitch lost half the audience it used to hold",
                ...
                "body": [
                    ...
                    "For scale, put it against something.  Twitch's own report last week counted 8.6 billion hours of gaming watched on the platform between 1 January and 1 September.  An entire global season of one of the biggest esports leagues in the world is therefore <mark>about two and a half percent</mark> of what a single platform watched of games in eight months.  Esports numbers sound enormous in isolation and normal in context.",
                    "The part nobody will lead with is where the audience went.  <mark>Twitch carried less than half of the season's hours watched, and Kick went from 0.2% of them in 2025 to 4.6% in 2026</mark> — more than twenty times its share in a single season.  The audience did not grow.  The part that stayed moved rooms.",
    ...
    },
    {
        ...
        "items": [
            {
                "title": "Mr Carlson's Lab does ten times his own median settling arguments about components, and has no sponsor of any kind",
                "hook": "539,000 subscribers.  A 731,651-view breakout at ten times median.  Zero brand deals on the entire channel.",
                "open": True,
                ...
                "body": [
                    ...
                    "The reason to pay attention is that it is not one lucky video.  It is the fourth step of a trend on the same new format — short, argumentative, one component, one contested claim, one definitive answer.  Track the ceiling: 76,000 on which capacitor to use, 108,000 on a tantalum across a zener, <mark>379,981 on the best cable for audio in June</mark>, 731,651 on diodes in August.  Four points, all upward, on the new format, while the legacy format holds flat at forty thousand.",
                ...
                "so_what": "The thing he sells without knowing it is adjudication.  His format is a claim, a meter and a verdict, and the credibility of the verdict is inseparable from the instrument producing it — which means the buyable placement is not a read at the top of the video, it is the equipment on the bench during the measurement.  For a test and measurement brand that is the most persuasive placement in the category, and it costs a fraction of what the same brand spends on trade advertising nobody reads.",
        ...
        "items": [
            {
                ...
                "so_what": "The interesting half of this is what the drop implies about the first wave.  A lot of teams tried generative AI on campaign work in the past year and a meaningful number stopped, which usually means the output was not good enough to ship rather than that the tools got worse.  Meanwhile every one of those teams now has a harder problem: their work has to survive being summarised by something that never watched it.",
            ...
            },
            {
                ...
                "body": [
                    "Digiday's round-up of this week's forecast upgrades carries a Madison and Wall figure that is more consequential than the growth numbers everyone is quoting.  <mark>AI-run and automated campaigns account for about 12% of US ad spend now</mark>, against a US market of roughly 479 billion dollars excluding political money, and the firm projects that to <mark>158 billion dollars, or 27% of the US market, by 2030</mark>.",
                    ...
                    "John Dawson, vice president of strategy at Jellyfish, puts the ceiling somewhere most people would not: we don't think automation in media stops at 20% or 30% — we think it gets to 90%.",
                    "Read that against today's lead and the picture resolves.  The market is growing on a one-off calendar of sporting events and an election, the buying of it is being handed to automated systems inside three companies, and the one thing buyers say they are increasing focus on fastest is creator and influencer work — the part of the market that is hardest to automate, because it involves a person agreeing to say something.",
                ],
                ...
                "so_what": "When buying gets automated, the machine optimises whatever it is given and the only remaining human decision is what you feed it.  That makes the creative and the partner choice the entire job, because everything downstream of them is a setting.  It also explains why creator work is the fastest-rising priority in the same survey — it is the one line a system cannot generate on its own.",
        ...
        "items": [
            {
                ...
                "hook": "The three richest brands on the list are the three dead ones.  Budget is not the variable.",
                "open": True,
                ...
                "body": [
                    ...
                    "The counter-example is not a luxury house.  Nordstrom's The Nordy Pod has held a regular release cadence for two years and <mark>put out nearly 120 episodes</mark>, and has been nominated for a Shorty Award.",
                    "So the variable is not money.  Hermès, Gucci and Chloé can outspend Nordstrom on any line item you care to name, and all three feeds are dead or dormant while Nordstrom's is on episode 120.  What separates them is whether anyone committed to a cadence before the first episode was recorded.",
...
FORECAST = [
    ...
    },
    {
        ...
        "body": "A data-removal service put a sponsor read on a true-crime video that did nearly 18 million views, and the largest personal injury firm in America independently concentrated its creator partners in the same genre.  Two advertisers with nothing in common found the same shelf, and the reason is that the content produces the emotional state their product resolves.  As soon as one measurement vendor publishes a genre-level performance cut showing this, the exclusion lists start coming apart — and the brands already in the genre will have had eighteen months of cheap inventory.",
...
TLDR = [
    ...
    "Aerie's comparable sales rose 19% on a quiet always-on creator programme while American Eagle fell 1% in the same quarter and same company, with the celebrity back-to-school campaign guided to flat.  Diary the week after your current campaign's quarter reports and write down today the one number you will judge it on.",
    ...
    "Valorant's season posted 218 million hours watched, up 3.1%, while average viewers fell 17.4% and peak fell 18.7% on airtime up 24.5%, and Kick went from 0.2% to 4.6% of the audience.  Require peak, average, airtime and channel count on every livestream proposal, and price a Kick line into your next gaming buy.",
    ...
    "Hermès, Chloé and Gucci have all let brand podcasts die while Nordstrom has published nearly 120 episodes in two years, so the variable is cadence commitment rather than budget.  Name your first twelve episodes and guests in the same meeting that approves the money, or commission a fixed season of six instead.",
]
...
SHARE = [
    ...
    },
    {
        ...
        "angle": "The same man, the same bench, the same camera: a 17-minute video did 10x what the 45-minute one did, and nothing about the craft changed.",
        "post": "A guy on YouTube called Mr Carlson has been filming at the same electronics bench for years. Same lighting. Same camera. Same voice.\n\nHis vintage radio restorations do about 40,000 views. In April, a full restoration did 37,809.\n\nIn August he posted a 17-minute video about why you would put two diodes facing opposite directions. It did 731,651.\n\nTen times his own median, on a channel of 539,000 subscribers, with nothing about the production changed.\n\nWhat changed is that the second video answers a question somebody already had. The restorations are beautiful, but they open on a piece of equipment and an implied ask: come and be interested in this with me.\n\nThe diode video opens with a question you can either answer or you cannot.\n\nI spend my week making things better. Tightening, balancing, fixing the audio, finding the version of a sequence that plays. And the gap between those two videos is not a gap I could have closed in the edit. No amount of pacing turns come and be interested into I need to know this.\n\nWhich is deflating to sit with, because it means the decision that mattered most was made before anyone shot anything, and the edit suite is downstream of it.\n\nI still think the edit is where films are won. I just think it is not where they are chosen.",
        "why": "An editor conceding that the decision which mattered most on a video happened before he ever touched it, with a specific ten-times number and no tidy resolution.",
    },
]
